        ...
        public function add_menu_page() {
           global $admin_page_hooks;
            ...
            if( ! isset( $admin_page_hooks['yit_plugin_panel'] ) ){
	            ...
	            apply_filters('yit_plugin_panel_menu_page_capability', current_user_can( 'manage_options' )) && add_menu_page( 'yit_plugin_panel', 'ABS', 'manage_options', 'yit_plugin_panel', NULL, YIT_CORE_PLUGIN_URL . '/assets/images/yithemes-icon.png', $position );
            }
        }
